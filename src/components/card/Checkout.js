...
const Checkout = (props) => {
    ...
    const enteredPostalCodeIsValid = !isNotFiveChars(enterdPostalCode);
    ...
    const formIsValid = enteredNameIsValid && enteredPostalCodeIsValid && enteredCityIsValid && enteredStreetIsValid;
    if (!formIsValid) {
        //not submit the cart data
        return;
